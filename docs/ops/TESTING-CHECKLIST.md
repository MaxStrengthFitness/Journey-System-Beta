...
- [ ] ~~**Consultation wizard**~~ — nothing opens it since Sep 24 2026 (the Relay "Assessment" task is the Pulse task and opens the client's Pulse). Check that instead: a Pulse task on the board lands on Notes & Profile → Pulse.
