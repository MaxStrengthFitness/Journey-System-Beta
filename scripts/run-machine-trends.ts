 ...
 * or to refresh the trends now rather than waiting for Sunday.
 *
...
async function main() {
  ...
  console.log(commit ? "COMMIT: machineTrends documents will be written." : "DRY RUN: nothing will be written.");
