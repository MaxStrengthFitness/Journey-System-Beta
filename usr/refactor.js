...
// But let's change things like: {(t.role === 'StudioOwner' || t.role === 'Admin' || t.role === 'Overseer') || (t.fullName === 'Austin Jurgens' && isAdmin) ? 'System Admin' : 'Performance Trainer'}
// to {(checkIsOwner(t) || checkIsAdmin(t, authTrainer?.email)) ? 'System Admin' : ROLE_LABELS[t.role] || 'Performance Trainer'}
