...
- **The guarantee:** the money-back covers monthly payers (AJ); the six-months-at-another-gym half says "when you pay in full" until AJ confirms it covers monthly payers; "upgrade", never "move" (a downgrade is a refund question nobody has answered).
...
- **The Academy's script** still says "we no longer bill you or auto renew you" and 30/60/90 days for leftover sessions. AJ approved softening it (handoff, Sep 24); the edit to `docs/msf-academy/…Script….txt` and the regenerated `consultation.json` wait for his word in the chat.
