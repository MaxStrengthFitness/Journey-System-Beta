      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-900 pb-8">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-3xl bg-linear-to-br from-[#F06C22] to-amber-600 flex items-center justify-center text-white shadow-2xl shadow-[#F06C22]/20">
                  ...
                  {manageableStudios.map((studio) => {
                    ...
                    return (
                      <div
                        ...
                        className="bg-slate-900 border border-slate-800/80 rounded-[28px] p-6 shadow-xl flex flex-col justify-between min-h-60 relative overflow-hidden cursor-pointer hover:border-[#F06C22]/50 transition-all group"
                      >
                        <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-transparent via-slate-850 to-transparent group-hover:via-[#F06C22] transition-colors" />
                        <div>
