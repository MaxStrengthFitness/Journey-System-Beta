...
import { collection, query, addDoc, getDocs, updateDoc, doc, serverTimestamp } from 'firebase/firestore';
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={newAnnouncement.targetScope} onValueChange={(v: 'universal' | 'network' | 'studio') => setNewAnnouncement(p => ({ ...p, targetScope: v, studioId: v === 'universal' ? 'all' : studios[0]?.id }))}>
                  ...
                  <SelectContent>
                    <SelectItem value="universal">Universal (All Hubs & Trainers)</SelectItem>
