...
import { Building2, ChevronLeft, MapPin, CheckCircle2, Lock, ArrowRight, Loader2 } from 'lucide-react';
...
export function StudioSelectionView({ 
  ...
  const hasAccessToStudio = (studioId: string) => {
    ...
    return authTrainer.primaryHomeStudioId === studioId || 
                      ...
                      >
                        ...
                        <div className="border-t border-slate-800/80 pt-4 mt-2">
                          {hasAccess ? (
                            ...
                            >
                              {isRequesting ? <Loader2 className="w-4 h-4 animate-spin" /> : <Lock className="w-3 h-3" />}
                              Request Access
                            </Button>
                          )}
                        </div>
