    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-start p-6 md:p-12 text-white">
      ...
      >
        <div className="text-center mb-10 flex flex-col items-center">
          ...
          <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px] max-w-md mt-1">
        ...
        <div className="space-y-12">
              ...
              <div key={network.id} className="space-y-4">
                <div className="flex items-center gap-3 border-b border-slate-800 pb-2">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] font-bold text-zinc-550 uppercase tracking-widest leading-none mt-0.5">
                      ...
                      >
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-[8px] font-black uppercase bg-[#F06C22]/10 text-[#F06C22] px-2 py-0.5 rounded-full border border-[#F06C22]/15">
                              Active
                            </span>
                          </div>
                        ...
                        <div className="border-t border-slate-800/80 pt-4 mt-2">
                          <p className="text-[8px] font-bold text-zinc-500 uppercase tracking-widest mb-2.5">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {studioTrainers.map((trainer) => (
                              <button
                                ...
                                className="px-3 py-1.5 rounded-xl bg-slate-950 hover:bg-[#F06C22] border border-slate-800 hover:border-[#F06C22] text-[10px] font-bold uppercase tracking-wider text-zinc-300 hover:text-white transition-all active:scale-95 flex items-center gap-1.5"
                              >
                                <span className="w-4 h-4 rounded bg-slate-900 flex items-center justify-center text-[8px] font-black group-hover:bg-transparent">
                                  {trainer.initials}
                                </span>
                            ...
                            {studioTrainers.length === 0 && (
                              <span className="text-[10px] text-zinc-650 font-bold uppercase tracking-widest">No assigned trainers</span>
                            )}
                          </div>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <span className="text-[8px] font-black uppercase bg-zinc-800 text-zinc-400 px-2 py-0.5 rounded-full border border-zinc-700/30">
                            Standalone
                          </span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {studioTrainers.map((trainer) => (
                            <button
                              ...
                              className="px-3 py-1.5 rounded-xl bg-slate-950 hover:bg-[#F06C22] border border-slate-800 hover:border-[#F06C22] text-[10px] font-bold uppercase tracking-wider text-zinc-300 hover:text-white transition-all active:scale-95 flex items-center gap-1.5"
                            >
                              <span className="w-4 h-4 rounded bg-slate-900 flex items-center justify-center text-[8px] font-black">
                                {trainer.initials}
                              </span>
                              <span>{trainer.fullName.split(' ')[0]}</span>
                            </button>
          ...
          {studios.length === 0 && (
            <div className="py-20 text-center bg-slate-900/60 rounded-[40px] border border-dashed border-slate-800">
              ...
              <p className="text-[9px] uppercase tracking-wider text-zinc-600 mt-2">Check corporate firestore database state</p>
            </div>
          )}
        </div>
        ...
        <div className="mt-12 flex justify-center">
          <Button
            variant="ghost"
            onClick={onBack}
            className="text-zinc-500 hover:text-white font-black uppercase text-[10px] tracking-widest gap-2 bg-transparent"
          >
