        ...
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            ...
            <button
              ...
              className="p-2 text-muted-foreground hover:text-slate-600 dark:hover:text-slate-200 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-lg border border-border mb-6">
            <p className="text-sm text-slate-700 dark:text-slate-300 mb-3 font-medium">
              To proceed, please type{" "}
              <span className="font-mono font-bold text-foreground select-all bg-slate-200 dark:bg-slate-700 px-1.5 py-0.5 rounded">
                {confirmationPhrase}
              </span>{" "}
              below:
            </p>
            <input
              ...
              className="w-full px-4 py-3 bg-card border border-slate-300 dark:border-slate-600 rounded-lg text-foreground placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 transition-shadow font-mono text-sm"
