  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col bg-bg-l border-none overflow-hidden m-0 animate-in fade-in zoom-in-[0.98] duration-200">
      <div className="p-6 md:px-10 md:py-8 border-b border-div-l flex flex-row items-start justify-between gap-2 shadow-sm bg-surface-1">
         <div>
           <h2 className="text-3xl font-black uppercase italic tracking-tighter text-ink-l1">Client Information</h2>
         ...
         <Button variant="ghost" size="icon" onClick={() => onOpenChange(false)} className="rounded-xl w-12 h-12 text-ink-l3 hover:text-ink-l1 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
            <X className="w-6 h-6" />
         </Button>
      </div>

        <div className="flex-1 overflow-hidden flex max-w-7xl w-full mx-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col md:flex-row overflow-hidden w-full m-0 p-0">
            <div className="px-6 py-4 md:py-8 md:w-64 border-b md:border-b-0 md:border-r border-div-l bg-bg-l">
              <TabsList className="bg-transparent border-none p-0 flex md:flex-col overflow-x-auto no-scrollbar gap-2 md:gap-4 md:h-auto items-start justify-start w-full">
                <TabsTrigger value="identity" className="data-[state=active]:bg-cyan/10 data-[state=active]:text-cyan data-[state=active]:shadow-none rounded-xl text-ink-l3 text-[11px] font-bold uppercase tracking-widest h-10 px-4 transition-all border border-transparent data-[state=active]:border-cyan/20 shrink-0 w-full justify-start">Identity</TabsTrigger>
                <TabsTrigger value="lifestyle" className="data-[state=active]:bg-cyan/10 data-[state=active]:text-cyan data-[state=active]:shadow-none rounded-xl text-ink-l3 text-[11px] font-bold uppercase tracking-widest h-10 px-4 transition-all border border-transparent data-[state=active]:border-cyan/20 shrink-0 w-full justify-start">Lifestyle</TabsTrigger>
                <TabsTrigger value="medical" className="data-[state=active]:bg-cyan/10 data-[state=active]:text-cyan data-[state=active]:shadow-none rounded-xl text-ink-l3 text-[11px] font-bold uppercase tracking-widest h-10 px-4 transition-all border border-transparent data-[state=active]:border-cyan/20 shrink-0 w-full justify-start">Medical</TabsTrigger>
                <TabsTrigger value="goals" className="data-[state=active]:bg-cyan/10 data-[state=active]:text-cyan data-[state=active]:shadow-none rounded-xl text-ink-l3 text-[11px] font-bold uppercase tracking-widest h-10 px-4 transition-all border border-transparent data-[state=active]:border-cyan/20 shrink-0 w-full justify-start">Goals</TabsTrigger>
                <TabsTrigger value="admin" className="data-[state=active]:bg-cyan/10 data-[state=active]:text-cyan data-[state=active]:shadow-none rounded-xl text-ink-l3 text-[11px] font-bold uppercase tracking-widest h-10 px-4 transition-all border border-transparent data-[state=active]:border-cyan/20 shrink-0 w-full justify-start">Admin</TabsTrigger>
                <TabsTrigger value="events" className="data-[state=active]:bg-cyan/10 data-[state=active]:text-cyan data-[state=active]:shadow-none rounded-xl text-ink-l3 text-[11px] font-bold uppercase tracking-widest h-10 px-4 transition-all border border-transparent data-[state=active]:border-cyan/20 shrink-0 w-full justify-start">Events</TabsTrigger>
              </TabsList>
            </div>
            ...
            <ScrollArea className="flex-1 p-6 md:p-10 bg-bg-l-card">
                 ...
                 <div className="flex flex-col gap-6">
                   <div className="flex items-center gap-4 p-6 border border-div-l rounded-3xl bg-surface-1 shadow-sm">
                     ...
                     <div className="flex-1">
                       <p className="text-[12px] font-black uppercase tracking-widest text-ink-l2">Avatar Profile</p>
                       <p className="text-xs text-ink-l3 opacity-70 mt-1">Upload photo feature pending integration.</p>
                     </div>
                   </div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                     <div className="space-y-2 flex flex-col">
                       ...
                       <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.firstName || ""} onChange={e => updateField('firstName', e.target.value)} />
                     </div>
                     <div className="space-y-2 flex flex-col">
                       <FormLabel>Last Name</FormLabel>
                       <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.lastName || ""} onChange={e => updateField('lastName', e.target.value)} />
                     </div>
                   </div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                     <div className="space-y-2 flex flex-col">
                       ...
                       <Input type="date" className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.dateOfBirth || ""} onChange={e => updateField('dateOfBirth', e.target.value)} />
                     </div>
                     <div className="space-y-2 flex flex-col">
                     ...
                     <div className="space-y-2 flex flex-col">
                       ...
                       <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium font-mono text-sm" value={(formData as any).mindbodyId || ""} onChange={e => updateField('mindbodyId' as any, e.target.value)} placeholder="e.g. 100005423" />
                     </div>
                   </div>

                   <div className="space-y-2 flex flex-col mt-4 pt-6 md:pt-8 border-t border-div-l">
                      <FormLabel>Phone</FormLabel>
                      <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.phone || ""} onChange={e => updateField('phone', e.target.value)} />
                   </div>
                   <div className="space-y-2 flex flex-col">
                      <FormLabel>Email</FormLabel>
                      <Input type="email" className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.email || ""} onChange={e => updateField('email', e.target.value)} />
                   </div>
                   <div className="space-y-2 flex flex-col">
                      <FormLabel>Address</FormLabel>
                      <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.address || ""} onChange={e => updateField('address', e.target.value)} />
                   </div>

                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 pt-6 md:pt-8 border-t border-div-l">
                      <div className="space-y-2 flex flex-col">
                         <FormLabel>Emergency Contact</FormLabel>
                         <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.emergencyContactName || ""} onChange={e => updateField('emergencyContactName', e.target.value)} />
                      </div>
                      <div className="space-y-2 flex flex-col">
                         <FormLabel>Emergency Phone</FormLabel>
                         <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.emergencyContactPhone || ""} onChange={e => updateField('emergencyContactPhone', e.target.value)} />
                      </div>
                   </div>
                 </div>
              </TabsContent>
                ...
                <div className="flex flex-col gap-6">
                   <div className="grid grid-cols-[1fr_auto] gap-6 items-end">
                      <div className="space-y-2 flex flex-col">
                        ...
                        <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.occupation || ""} onChange={e => updateField('occupation', e.target.value)} />
                      </div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 border-t border-div-l pt-6 md:pt-8">
                      <div className="space-y-2 flex flex-col">
                         ...
                         <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.leadSource || ""} onChange={e => updateField('leadSource', e.target.value)} />
                      </div>
                      <div className="space-y-2 flex flex-col">
                         <FormLabel>Referred By</FormLabel>
                         <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" value={formData.referredBy || ""} onChange={e => updateField('referredBy', e.target.value)} />
                      </div>
                   </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="medical" className="m-0 space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-b border-div-l pb-8">
                   <div className="space-y-2 flex flex-col">
                      ...
                      <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" placeholder="e.g. 5'10&quot;" value={formData.height || ""} onChange={e => updateField('height', e.target.value)} />
                   </div>
                   <div className="space-y-2 flex flex-col">
                      <FormLabel>Weight</FormLabel>
                      <Input className="h-12 border-div-l rounded-xl bg-surface-1 font-medium" placeholder="lbs" value={formData.weight || ""} onChange={e => updateField('weight', e.target.value)} />
                   </div>
                </div>
                ...
                <div className="space-y-2 flex flex-col pt-6 md:pt-8 border-t border-div-l">
                   ...
                   <Textarea className="min-h-[160px] p-5 text-sm border-div-l rounded-2xl bg-surface-1 font-medium leading-relaxed" value={formData.medicalHistory || ""} onChange={e => updateField('medicalHistory', e.target.value)} />
                </div>

                <div className="space-y-2 flex flex-col border-t border-div-l pt-6 md:pt-8">
                   <FormLabel>Clinical Notes</FormLabel>
                   <Textarea className="min-h-[160px] p-5 text-sm border-div-l rounded-2xl bg-surface-1 font-medium leading-relaxed focus:border-red-500/50 transition-colors" placeholder="Trainer-specific contraindications or constraints" value={formData.clinicalNotes || ""} onChange={e => updateField('clinicalNotes', e.target.value)} />
                </div>
              </TabsContent>
              ...
              <TabsContent value="goals" className="m-0 space-y-8">
                <div className="space-y-2 flex flex-col">
                   ...
                   <Textarea className="min-h-[200px] p-5 text-[15px] border-div-l rounded-3xl bg-surface-1 leading-relaxed font-medium" placeholder="Client intent and motivation for starting." value={formData.globalNotes || ""} onChange={e => updateField('globalNotes', e.target.value)} />
                </div>
                <div className="space-y-2 flex flex-col mt-6 border-t border-div-l pt-8">
                   <FormLabel>Coach Strategy Notes</FormLabel>
                   <Textarea className="min-h-[160px] p-5 text-sm border-div-l rounded-2xl bg-surface-1 leading-relaxed font-medium" placeholder="How do you coach this client? What cues do they respond to?" value={formData.discoveryNotes || ""} onChange={e => updateField('discoveryNotes', e.target.value)} />
                </div>
                <div className="space-y-2 flex flex-col mt-6 border-t border-div-l pt-8">
                   <FormLabel>SMART Goal</FormLabel>
                   <Input className="h-14 text-lg border-div-l rounded-2xl bg-surface-1 font-semibold" placeholder="e.g. Skiing trip ready by Nov 15th" value={(formData as any).smartGoal || ""} onChange={e => updateField('smartGoal' as any, e.target.value)} />
                </div>
              </TabsContent>
              ...
              <TabsContent value="admin" className="m-0 space-y-8">
                 ...
                 <div className="space-y-4 mt-6 border-t border-div-l pt-8">
                   ...
                   <div className="flex flex-wrap gap-2">
                     ...
                     {studios.length <= 1 && <p className="text-xs text-ink-l3 font-medium">No other studios available for cross-training.</p>}
                   </div>
                 </div>
              </TabsContent>
              ...
              <TabsContent value="events" className="m-0 space-y-8">
                <div className="space-y-6">
                  <div className="flex items-center justify-between pb-4 border-b border-div-l">
                    ...
                    <Button onClick={handleAddEvent} size="sm" className="h-10 px-6 rounded-xl bg-cyan hover:bg-cyan/90 text-white font-black uppercase tracking-widest text-[11px] shadow-sm">
                      + Add Event
                    </Button>
                  </div>
                  ...
                  <div className="space-y-4">
                    {!(formData.events?.length) && (
                      <div className="p-12 text-center border-2 border-dashed border-div-l rounded-3xl bg-surface-1/50">
                        <p className="text-sm text-ink-l3 font-medium">No events scheduled. Track vacations, medical events, and scans here.</p>
                      </div>
                    )}
                    {(formData.events || []).map((event) => (
                      <div key={event.id} className="p-6 border border-div-l rounded-3xl bg-surface-1 shadow-sm space-y-4 relative overflow-hidden group">
                        <Button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-[1fr_200px] gap-4 pr-10">
                          <Input 
                            ...
                            className="font-bold border-div-l h-12 text-lg bg-white dark:bg-slate-900" placeholder="Event Title"
                          />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-4">
                          ...
                          <Input 
                            ...
                            className="border-div-l h-12 text-[15px] bg-white dark:bg-slate-900 font-medium" placeholder="Optional notes... (e.g. Cleared for activity)" 
                          />
                        </div>
                      </div>
                    ))}
        ...
        <div className="p-4 md:px-10 md:py-6 border-t border-div-l bg-surface-1 mt-auto flex-none flex justify-end shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)]">
           <div className="flex items-center gap-4 w-full md:w-auto">
             <Button variant="outline" className="h-12 rounded-xl font-bold uppercase tracking-widest text-[11px] w-full md:w-32 border-div-l hover:bg-slate-100 dark:hover:bg-slate-800" onClick={() => onOpenChange(false)}>
                Close
             </Button>
             <Button 
               ...
               className={`w-full md:w-auto h-12 md:px-10 rounded-xl font-black uppercase tracking-widest text-[11px] shadow-md transition-all ${
                 dirtyFields.size > 0 ? "bg-cyan hover:bg-[#00D9C1] text-[#050C16]" : "bg-ink-l2/5 text-ink-l3 border border-div-l backdrop-blur-md opacity-50"
               }`}
             >
               {isSaving ? "Saving..." : dirtyFields.size > 0 ? `Save Profile Changes (${dirtyFields.size})` : "No Edits Made"}
             </Button>
           </div>
        </div>
    </div>
