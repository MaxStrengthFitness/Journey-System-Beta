 ...
 *
 * NOTE: this is a deliberate copy of `functions/src/mindbody/passFields.ts`.
 * The Cloud Functions package has its own tsconfig and dependency tree and
 * cannot import from `src/`, so the two must be edited together.
 *
